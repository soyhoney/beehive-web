              ...
              {files.map((file) => (
                <li key={file.name} className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    aria-label={`${file.name} ${S.fileRemove}`}
                    className="inline-flex size-5 shrink-0 items-center justify-center rounded text-neutral-400 transition hover:bg-neutral-100 hover:text-neutral-700 dark:hover:bg-neutral-800 dark:hover:text-neutral-200"
                  >
