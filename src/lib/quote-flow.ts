...
export const CATEGORIES: readonly Category[] = [
  { id: "A", title: "동행·수행 출장", desc: "의전, 수행통역, 출장 어레인지" },
  { id: "B", title: "정부·공공기관 프로젝트", desc: "사무국 운영, 입찰, 장기 용역" },
  { id: "C", title: "방송·행사·전문 통역", desc: "동시·순차통역, 촬영, 개막식" },
  { id: "D", title: "번역·출판", desc: "문서, 도록, 자막, 감수" },
  { id: "E", title: "교육·트레이닝", desc: "영어 수업, 기업 교육" },
  { id: "F", title: "기타 문의", desc: "위에 없는 유형은 자유롭게" },
] as const;
...
export const FLOW_D: readonly Question[] = [
  ...
  q("volume", "choice", "분량을 대략 알려주세요.", {
    sub: "정확하지 않아도 됩니다. 파일이 있으면 첨부해 주세요.",
    options: VOLUME_OPTIONS,
    followInput: {
      when: VOLUME_OPTIONS.indexOf(DIRECT_INPUT),
      label: "분량",
      ph: "예: A4 30페이지 / 영상 40분",
    },
    file: true,
  }),
  ndaQ(),
